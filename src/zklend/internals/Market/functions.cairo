...
const DEBT_FLAG_FILTER = 0x2aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa;
...
namespace Internal {
    ...
    func calculate_user_collateral_data_loop{
        ...
        user: felt, apply_borrow_factor: felt, flags: felt, reserve_count: felt, reserve_index: felt
    ) -> (collateral_value: felt, collateral_required: felt) {
        alloc_locals;
